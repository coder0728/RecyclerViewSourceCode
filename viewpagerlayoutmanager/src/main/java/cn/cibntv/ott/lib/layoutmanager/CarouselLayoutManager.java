package cn.cibntv.ott.lib.layoutmanager;
...
public class CarouselLayoutManager extends ViewPagerLayoutManager {
    ...
    public CarouselLayoutManager(Builder builder) {
        this(builder.context, builder.itemSpace, builder.minScale, builder.angle, builder.orientation,
                builder.maxVisibleItemCount, builder.moveSpeed, builder.distanceToBottom,
                builder.reverseLayout);
    }

    private CarouselLayoutManager(Context context, int itemSpace, float minScale, float angle, int orientation,
    ...
    public static class Builder {
        ...
        private static float INTERVAL_ANGLE = 10f;
        ...
        public CarouselLayoutManager.Builder setAngle(float angle) {
            this.angle = angle;
            return this;
        }
